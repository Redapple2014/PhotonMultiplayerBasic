...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    [Tooltip("IF you dont want to see the player list then directly you can jump to load level")]
    ...
    public override void OnDisconnected(DisconnectCause cause)
    {
        ...
        Debug.Log("you have been disconnected from the server , so you  have to start from begening again");
    ...
    {
        Debug.Log("<Color=Green>OnJoinedRoom</Color> with " + PhotonNetwork.LocalPlayer.NickName);
    }

    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        foreach (RoomListings room in _listing)
        {
            if (room != null)
    ...
    public override void OnLeftRoom()
    {
       // ToggleScreen("SelectionPanel");
        ...
        //This function we need to call when we need to disconnect the user from server 
